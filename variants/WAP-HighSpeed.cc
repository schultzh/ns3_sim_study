...
NS_LOG_COMPONENT_DEFINE ("wifi-HighSpeed");
...
CalculateThroughput ()
{
  ...
  avgThroughput.open("HS-throughput.csv", std::ios_base::app);
...
mobility.SetPositionAllocator ("ns3::GridPositionAllocator",
  ...
  monitor->SerializeToXmlFile(datetime()+"_HS_FlowMon.xml", true, true);
  AnimationInterface anim(datetime()+"_HS.xml");
